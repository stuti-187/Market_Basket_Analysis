...
class Apriori {
    ...
    /**
      1. Creates the item table
         2. Generates the access key for each item
         3. Calculates all items and their repeats - Level 1
         Note: Minimum repeat is calculated
    **/
    ...
    /**
        1.Superimposes the amount of the superconductor according to the input of the item identifier
    **/
    ...
    /**
        1. Combine two arrays and remove additional quantities
    **/
    ...
    /**
        1. Returns the item's name according to the item ID or items
           {1,2,3,4} => {A,B,C,D}
    **/
    ...
    /**
        Returns the duplicate set item
    **/
  ...
  // Removes the sub-sets for larger sets
...
//          1. Calculate the final rules according to the minimum confinement level    
